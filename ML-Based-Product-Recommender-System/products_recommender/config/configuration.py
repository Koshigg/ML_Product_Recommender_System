...
from products_recommender.utils.util import read_yaml_file
from products_recommender.exception.exception_handler import AppException
from products_recommender.entity.config_entity import DataIngestionConfig, DataValidationConfig, DataTransformationConfig, ModelTrainerConfig, ModelRecommendationConfig
from products_recommender.constant import *
...
class AppConfiguration:
    ...
    def get_data_validation_config(self) -> DataValidationConfig:
        try:
            ...
            dataset_dir = data_ingestion_config['dataset_dir']
            artifacts_dir = self.configs_info['artifacts_config']['artifacts_dir']
            products_csv_file = data_validation_config['products_csv_file']
            ratings_csv_file = data_validation_config['ratings_csv_file']

            products_csv_file_dir = os.path.join(artifacts_dir, dataset_dir, data_ingestion_config['ingested_dir'], products_csv_file)
            ...
            response = DataValidationConfig(
                ...
                products_csv_file = products_csv_file_dir,
    ...
    def get_recommendation_config(self) -> ModelRecommendationConfig:
        try:
            ...
            product_name_serialized_objects = os.path.join(artifacts_dir, data_validation_config['serialized_objects_dir'], 'product_names.pkl')
            product_pivot_serialized_objects = os.path.join(artifacts_dir, data_validation_config['serialized_objects_dir'], 'product_pivot.pkl')
            ...
            # print(product_name_serialized_objects,product_pivot_serialized_objects)
          
            response = ModelRecommendationConfig(
                product_name_serialized_objects = product_name_serialized_objects,
                product_pivot_serialized_objects = product_pivot_serialized_objects,
